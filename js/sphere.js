// let app, fnAddEventListener, fnRequestAnimationFrame;
//
...
//         window.setTimeout(fnCallback, 1500);
//     };
//     fnAnimFrame(fnCallback);
// };
//
// // (window.iPerspective = 150, window.iNewParticlePerFrame = 1)
//
...
//
// app = function () {
//     let Particle, ctxRender, fAngle, fCosAngle, fMaxAX, fMaxAY, fMaxAZ, fPI, fSinAngle, fStartVX, fStartVY, fStartVZ,
//         fVX, fnACos, fnCos, fnMax, fnMin, fnNextFrame, fnRender, fnRnd, fnRnd2, fnSetSize, fnSin, fnSwapList, h,
//         iProjSphereX, iProjSphereY, iRadiusSphere, nBody, oBuffer, oDoc, oRadGrad, oRender, stats, w;
//     stats = new Stats();
//     stats.setMode(0);
...
//
//     fnSetSize = function () {
//         nCanvasRender.width = w = window.innerWidth * 0.7;
//         nCanvasRender.height = h = window.innerHeight * 0.7;
//         iProjSphereX = w / 2;
//         iProjSphereY = h / 2;
//         return {
//             w: w,
...
//         let iAddParticle, iCount, p, pNext;
//         stats.begin();
